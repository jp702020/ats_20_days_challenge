...
import bb from "../assets/radhikaSharma.png";
import reel1 from "../assets/reels3.gif";

const TravelGProfile = () => {
  return (
    <>
      <div className="product_g_profile_container">
        ...
        <div className="profile_card">
          ...
          <div className="p_g_p_right">
            <h6>Radhika Sharma</h6>
            <p className="p_g_p_right_connect">@radhika_nomliers</p>
            <p>Your shortcut to the latest travel hotsot and tips</p>
